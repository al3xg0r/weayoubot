...
TEXTS = {
    ...
    "uk": {
        ...
        "done_interval": "✅ Готово! Погода для <b>{city}** кожні {val} год.",
        "done_daily": "✅ Готово! Погода для <b>{city}** щодня о {val}:00.",
